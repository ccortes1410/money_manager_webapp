...
const Header = () => {
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-light" style={{backgroundColor:"darkturqoise",height:"1in"}}>
                <div class="container-fluid">
                    <h2 style={{paddingRight: "0%"}}>Transactions</h2>
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" style={{fontSize: "larger"}} href="/about">About</a>
                            </li>
                            <li class="nav-item">
